...
<template>
  ...
  <div id="container">
    <div id="explorer" class="border">
      <div id="topBar" class="topBar">

        <div id="archive">
          <img src="/icons/folder.gif" alt="folder">
          <h2>archive</h2>
        </div>
...
#info {
  ...
  background-image: url("~/assets/archive/clouds2.gif");
...
#background {
  background-image: url("~/assets/archive/glacial.gif")
}
